...
?>
    ...
    <div class="container mt-5 justify-content-center align-items-center">
        <header>
            <div class="container">
                <div id="carouselExampleIndicators" class="carousel slide border border-warning rounded shadow"
                     data-ride="carousel">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-warning rounded-bottom sticky-top shadow">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="frontend/Usluge/usluge_servis_racunara.php">Usluge</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row">
                    <div class="col-sm-4 text-center my-3">
                        <div class="card text-light bg-warning"
                            ...
                            <img class="card-img-top rounded rounded rounded rounded rounded"
                                 src="frontend/jumbotron_slike/kartice - orvi deo.svg" alt="Card image cap"/>
                            <div class="card-body">
