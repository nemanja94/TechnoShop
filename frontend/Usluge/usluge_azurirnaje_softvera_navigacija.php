...
<div class="container">
    ...
    <hr />
    <div class="container" style="height: 1220px;">
            ...
            <div class="container">
                <ul class="nav nav-pills nav-fill p-3 border border-warning rounded shadow bg-light">
                    ...
                    <li class="nav-item m-2">
                        <a class="nav-link bg-dark border border-warning text-warning shadow active" href="usluge_azurirnaje_softvera_navigacija.php">Azurirnaje softvera navigacija</a>
                    </li>
                </ul>
            </div>
            <!--Tabs-->
            ...
            <div class="col-sm-6 col-md-6 col-lg-4 my-3">
                <div class="card text-light bg-dark border border-warning shadow">
                    <div class="card-body">
                        ...
                        <hr class="bg-warning">
                        <p class="card-text text-light">Cena: 1000rsd</a>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-6 col-lg-4 my-3">
